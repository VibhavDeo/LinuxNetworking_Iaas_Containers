...
yaml_file_path = os.path.join(current_directory, '..', 'automation', 'variables', 'delete_vm_variables.yml')
...
def run_ansible_playbook(playbook_path):
    try:
        ...
        print("Ansible playbook executed successfully and the VM is deleted.")
    except subprocess.CalledProcessError as e:
        print(f"Error executing Ansible playbook: {e}")
        return False

playbook_path = '../automation/ansible_delete_vm.yaml'
